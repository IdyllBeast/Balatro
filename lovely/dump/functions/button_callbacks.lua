LOVELY_INTEGRITY = '54306cb8b7d8a6f7d7c11dda60f1796d024284ec94e1d6e8043365ae7e5d4a49'
...
G.FUNCS.flash = function(e)
  if G.CONTROLLER.text_input_hook and G.CONTROLLER.text_input_id == e.config.id:sub(1,string.len(G.CONTROLLER.text_input_id)) then
...
function GET_TEXT_FROM_INPUT()
  ...
  for i = 1, #hook.children do
    if hook.children[i].config and hook.children[i].config.id:sub(1, 8+string.len(G.CONTROLLER.text_input_id)) == G.CONTROLLER.text_input_id..'_letter_' and hook.children[i].config.text ~= '' then
