LOVELY_INTEGRITY = '5b51f0865dc5c41616e2fdd97bc6e7ed55db931cb7858671ab18ed610b5ab8fc'
...
Set `prefix_config.key = false` on your object instead.]]):format(obj.key), obj.set)
    ...
    SMODS.Font = SMODS.GameObject:extend {
        ...
        inject = function(self)
            ...
            self.full_path = (self.mod_path or self.mod and self.mod.path or SMODS.path) ..
