LOVELY_INTEGRITY = 'b333b8708eff042ac5b9a8b0b57df633a99e73c76b5c87d369c3ccab2998d1f1'
...
function Card:update_joker_display(force_update, force_reload, _from)
    if self.ability and (self.ability.set == 'Joker' or self.ability.set == 'Colour' or self.ability.set == "Shape") then
