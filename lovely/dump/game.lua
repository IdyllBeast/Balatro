LOVELY_INTEGRITY = 'c3c9f8d0cad7fa81fda480fb7c0bdb9c32cfc0b41fdf26c7f125ad3681274b32'
...
function Game:init_item_prototypes()
    ...
    table.sort(self.P_CENTER_POOLS["Edition"], function (a, b) return a.order < b.order end)
                            ...
                            Handy.regular_keybinds.on_shop_loaded()
                                ...
                                if not shop_exists then
                                    ...
                                    if G.load_shop_vouchers then 
                                        ...
                                        if (G.GAME.modifiers.cry_voucher_restock_antes == nil or G.GAME.round_resets.ante % G.GAME.modifiers.cry_voucher_restock_antes == 0) then
